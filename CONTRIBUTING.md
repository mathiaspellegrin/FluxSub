...
**Issues:** Before opening one, check [existing issues](https://github.com/mathiaspellegrin/FluxSub/issues). When you do file something—steps to reproduce help a lot. So does your environment (OS, Node version, browser, wallet).
...
More context: [docs/architecture.md](docs/architecture.md), [docs/contracts.md](docs/contracts.md). By contributing you’re agreeing to license your work under MIT.
